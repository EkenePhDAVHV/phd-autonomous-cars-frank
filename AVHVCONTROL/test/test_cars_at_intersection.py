...
pos_sum = {}
vel_sum = {}
for lights_position in simulation.environment.environment_objects[TrafficLight]:
    print(lights_position.position.get_value())
    print(lights_position.traffic_node.position.x)
