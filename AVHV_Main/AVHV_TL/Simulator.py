...
from AVHV_Main.AVHV_TL.Plotter import Plotter
...
class Simulation:
    ...
    def __calculate_layout(self):
        ...
        self.__scene.add(self.__scene.text("~ Traffic Lights Control ~",
                                           insert=(550, 125),
                                           font_size=16,
                                           fill="#000000",
                                           style="font-family: Lucida Sans Unicode, "
        ...
        # self.__scene.add(self.__scene.text("Experiment Summary (PDF)",
        #                                    insert=(550, 610),
        #                                    font_size=15,
        #                                    fill="#0000FF",
        #                                    style="font-family: Lucida Sans Unicode, "
        ...
        #                                          "Sans-serif;"))
        #
        # self.__scene.add(self.__scene.text("Experiment w/ Reservation Node",
        #                                    insert=(570, 680),
        #                                    font_size=15,
        #                                    fill="#0000FF",
        #                                    style="font-family: Lucida Sans Unicode, "
        ...
        #                                          "Sans-serif;"))
        #
        # self.__scene.add(self.__scene.text("Experiment w/ Safe Distance "
        # "&", insert=(570, 710), font_size=15, fill="#0000FF",
        # style="font-family: Lucida Sans Unicode, " "Sans-serif;" "text-decoration:
        # underline"))
        #
        # self.__scene.add(self.__scene.text("4-Way Intersection Collision "
        #                                    "Control",
        #                                    insert=(570, 735),
        #                                    font_size=15,
        #                                    fill="#0000FF",
    ...
    def __draw_current(self, time_step):
        ...
        self.__frame.add(
            self.__frame.text(str(len(self.environment.cars_braked)),
                              insert=(665, 160), font_size=16, fill="#000000",
    ...
    def __start_simulation(self):
        ...
        print("AVHV Control with Traffic Lights - Please wait for a while...")
