...
from tqdm.utils import (FormatReplace, _is_ascii, _unich, _unicode, disp_len, disp_trim)
...
class Tqdm(tqdm):
    def __init__(self, iterable=None, desc=None, total=None, leave=True, file=None,
                 initial=0, disable=False):
        super().__init__(iterable=iterable, total=total, file=file, initial=initial)
    ...
    def format_meter(n, total, elapsed, ncols=None, prefix='', ascii=False, unit='it',
        ...
        if total:
            ...
            full_bar = MyBar(frac,
                           ...
                           charset=MyBar.ASCII if ascii is True else ascii or MyBar.UTF,
                           colour=colour)
            ...
            full_bar = MyBar(0,
                           max(1, ncols - disp_len(nobar)) if ncols else 10,
                           charset=MyBar.BLANK, colour=colour)
            res = bar_format.format(bar=full_bar, **format_dict)
            return disp_trim(res, ncols) if ncols else res
        else:
