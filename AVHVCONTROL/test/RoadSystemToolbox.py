from AVHVCONTROL.RoadSystem import RoadSystem
from AVHVCONTROL.Simulator import TrafficNode, _TrafficSystem, RoadSystem
#from AVHVCONTROL.RoadSystem import TrafficNode
    ...
    def crossroads():
        return RoadSystem(
            nodes=[
                ...
                TrafficNode(416, [15, 50], curve_radius=35, curve_center=[50, 50]),
